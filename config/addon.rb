module AddonConfig
  ...
  def self.error_messages
    { "ADDON_NAME" => instructions("name", "ADDON_NAME"),
      ...
      "ADDON_CONFIG_VARS" => instructions("config vars", "ADDON_CONFIG_VARS", "This is a comma separated list of the configuration variables that will be set by your add-on: https://devcenter.heroku.com/articles/add-on-manifest#fields"),
      "ADDON_REGIONS" => instructions("available regions", "ADDON_REGIONS", "This is a comma separated list of geographical regions supported by your add-on (e.g., \"us,eu\"): https://devcenter.heroku.com/articles/add-on-manifest#fields"),
